...
// Create a reference to "mountains.jpg"
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                String url="http://10.0.2.2/android/Server/register.php?first_name="+name+"&email="+etEmail.getText().toString()+"&password="+etPassword.getText().toString()+"&picture_path="+ downloadUrl;
//http://
...
//login
                    String url="http://10.0.2.2/android/Server/login.php?email="+etEmail.getText().toString()+"&password="+etPassword.getText().toString() ;
