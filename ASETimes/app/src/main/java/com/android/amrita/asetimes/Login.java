...
// Create a reference to "mountains.jpg"
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                String url="http://10.0.2.2/ase-times/Server/register.php?first_name="+name+"&email="+etEmail.getText().toString()+"&password="+etPassword.getText().toString()+"&picture_path="+ downloadUrl;
...
//login
                    String url="http://10.0.2.2/ase-times/Server/login.php?email="+etEmail.getText().toString()+"&password="+etPassword.getText().toString() ;
